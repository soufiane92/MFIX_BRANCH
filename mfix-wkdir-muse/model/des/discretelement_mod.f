...
! ==================================================================== !
! ====================== DECLARATION OF VARIABLES ME ================= !
! ==================================================================== !

      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: PPOS_ME
      
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_POS_OLD_ME  
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_POS_NEW_ME
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_POS_FREE_ME
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_POS_DEMI_ME
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_POS_GHOST_ME
      
      
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_VEL_OLD_ME    
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_VEL_NEW_ME
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_VEL_FREE_ME
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_VEL_DEMI_ME
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: DES_VEL_GHOST_ME
      ...
      INTEGER, DIMENSION(:), ALLOCATABLE :: NEIGHBORS_ME
      INTEGER, DIMENSION(:), ALLOCATABLE :: NEIGHBORS_OLD_ME
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: PFT_NEIGHBOR_ME
      DOUBLE PRECISION, DIMENSION(:,:), ALLOCATABLE :: PFT_NEIGHBOR_OLD_ME
...
! ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ !   
    SUBROUTINE PARTICLE_COPY_OLD_NEW_ME
     ...
     END SUBROUTINE PARTICLE_COPY_OLD_NEW_ME
! ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ !   

! ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ !   
     SUBROUTINE PARTICLE_COPY_NEW_OLD_ME
...
! ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ !   
     SUBROUTINE PARTICLE_COPY_FREE_OLD_ME
...
! ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ !   
     SUBROUTINE PARTICLE_COPY_DEMI_OLD_ME
...
! ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ !       
     SUBROUTINE EXPORT_ME(FILENAME,PLIST_POS_ME,PLIST_VEL_ME,PLIST_RADIUS_ME,&
       ...
       !PRINT*,"EXPORT ME DONE"
    
     END SUBROUTINE EXPORT_ME
! ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ !
